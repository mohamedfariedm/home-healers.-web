...
function ContactFormExpo() {
  ...
  return (
    <FormProvider {...methods}>
      <div className="main-container w-full flex  pt-[32px] pb-[32px] pr-[32px] pl-[32px] flex-col gap-[32px] items-center bg-[#37200B] rounded-[16px] relative z-10 mx-auto my-0">
        <form
          onSubmit={methods.handleSubmit(onSubmit)}
          className="flex w-full  flex-col gap-[40px] items-center shrink-0 relative"
        >
          <div className="flex flex-col gap-[32px] items-center self-stretch shrink-0 relative z-[1]">
            <div className="flex flex-col xl:flex-row gap-[32px] items-start self-stretch shrink-0 relative z-[2]">
              {/* First Name */}
              <div className="flex w-full xl:w-[48.25%]  flex-col gap-[8px] self-stretch shrink-0 relative z-[11]">
                ...
                <input
                  ...
                  className="outline-none text-black w-full  h-[56px] bg-[#5F3F23] rounded-[15px] px-[16px] placeholder:text-[#DCDCDC] "
                />
              ...
              {/* Last Name */}
              <div className="flex w-full xl:w-[48.25%]  flex-col gap-[8px] self-stretch shrink-0 relative z-[3]">
                <label className="text-[14px] font-medium text-[#FFFFFF]">
                  {t("form.lastName")} *
                </label>
                <input
                  ...
                  className="outline-none text-black placeholder:text-[#DCDCDC] w-full  h-[56px] bg-[#5F3F23] rounded-[15px] px-[16px] "
                />
            ...
            <div className="flex flex-col gap-[8px] self-stretch shrink-0 relative z-[29]">
              ...
              <textarea
                ...
                className="outline-none placeholder:text-[#DCDCDC] text-black w-full  h-[150px] bg-[#5F3F23] rounded-[15px] py-[16px] px-[16px] "
              />
...
export default ContactFormExpo;
