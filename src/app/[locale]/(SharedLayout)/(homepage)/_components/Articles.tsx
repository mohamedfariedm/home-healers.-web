...
function Articles({ t,homeData,NewsData }: { t: TFunction,homeData:any,NewsData:any }) {
  ...
  return (
    <div className="main-container flex w-full xl:w-[1440px] pt-[96px] pr-0 pb-[96px] pl-0 flex-col gap-[48px] items-center flex-nowrap relative mx-auto my-0">
      ...
      <Link href={'/blog'} className="flex hover:bg-white transition-all duration-500 cursor-pointer w-[170px] pt-[8px] pr-[24px] pb-[8px] pl-[24px] flex-col gap-[8px] justify-center items-center shrink-0 flex-nowrap rounded-[41px] border-solid border border-[#f8992f] relative z-[26] pointer">
