...
export default function AddPatientModal({ isOpen, onClose }: AddPatientModalProps) {
  ...
  const relationships = ["الأب", "الأم", "الأخ", "الأخت", "الابن", "الابنة", "الزوج", "الزوجة", "أخرى"]
  const nationalities = ["السعودية", "الإمارات", "الكويت", "قطر", "البحرين", "عمان", "مصر", "الأردن", "أخرى"]
      ...
      <div className="relative bg-white rounded-3xl w-full max-w-4xl max-h-[95vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-8 p-6 pt-16">
          ...
          <div className="flex justify-center">
            <h2 className="text-xl font-bold text-[#1e1e1e]">اضافة مريض جديد</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 items-end">
              ...
              <input
                ...
                className="w-full p-3 border border-[#d0d5dd] rounded-lg text-right text-sm placeholder-[#736b7a]"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2 items-end">
                ...
                <div className="flex border border-[#d0d5dd] rounded-lg overflow-hidden">
                  <input
                    ...
                    className="flex-1 p-3 text-right text-sm placeholder-[#736b7a] border-none outline-none"
                  />
              ...
              {/* Email */}
              <div className="flex flex-col gap-2 items-end">
                <label className="text-sm text-[#1e1e1e]">البريد الالكتروني</label>
                <input
                  type="email"
            ...
            <div className="flex flex-col gap-2 items-end">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className="w-full p-3 border border-[#d0d5dd] rounded-lg text-right text-sm text-[#736b7a]"
                />
                <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
                  <div className="w-6 h-6 relative overflow-hidden">
