...
export default function SessionSelectorModal({ isOpen, onClose }: SessionSelectorModalProps) {
  ...
  const sessionOptions: SessionOption[] = [
    {
      ...
      count: 1,
      label: "1 جلسة علاج",
      iconUrl: "https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-05-29/328N24MOey.png",
      price: 300,
    },
    {
      id: 2,
      count: 2,
      label: "2 جلسة علاج",
      iconUrl: "https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-05-29/eXFJC24p7f.png",
      price: 550,
    },
    {
      id: 3,
      count: 3,
      label: "3 جلسة علاج",
      iconUrl: "https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-05-29/j3EMf4CUjv.png",
      price: 800,
    },
  ]

  const selectedOption = sessionOptions.find((option) => option.id === selectedSession) || sessionOptions[0]
      ...
      <div className="relative bg-white rounded-3xl w-full max-w-2xl max-h-[95vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-8 p-6 pt-16">
          ...
          <div className="flex justify-center">
            <h2 className="text-xl font-bold text-[#1e1e1e]">اختيار عدد الجلسات</h2>
          </div>
              ...
              {sessionOptions.map((option) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-semibold text-[#1e1e1e]">{option.label}</span>
                    <div
          ...
          <div className="flex flex-col gap-4 items-center">
            <div className="bg-white rounded-xl p-3">
              <span className="text-lg font-bold text-[#62a0f6]">{selectedOption.price} ريال</span>
            </div>
            <button
