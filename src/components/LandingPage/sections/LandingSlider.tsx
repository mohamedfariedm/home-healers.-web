  ...
  const renderSlide = (item: any, index: number) => {
    switch (slideType) {
        ...
        return (
          <SwiperSlide key={item.id || index}>
            ...
            >
              ...
              <div className="p-4">
                {blogTitle && (
                  <h3 className="text-lg font-semibold text-[#1e1e1e] mb-2 line-clamp-2 min-h-[56px]">
                    {blogTitle}
                  </h3>
                )}
                {blogDescription && (
        ...
        return (
          <SwiperSlide key={item.id || index}>
            <div
              ...
              className="relative bg-white shadow-lg rounded-3xl overflow-hidden w-full h-[420px] flex flex-col mx-auto border border-gray-100 cursor-pointer hover:shadow-xl transition-shadow"
            >
      ...
      case "faqs":
        return (
          <SwiperSlide key={item.id || index}>
            <div className="bg-[#f8fbfc] rounded-[16px] p-6 border border-gray-200">
              <h3 className="text-lg font-semibold text-[#5d9d9f] mb-3">
